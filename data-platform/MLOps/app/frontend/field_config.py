...
FIELDS = (
    ...
    FieldConfig("region_rating_client", "Classificação da região", "Scores e localização", "integer", 2, minimum=1, maximum=3, step=1),
    ...
    FieldConfig("amt_goods_price", "Preço do bem", "Valores financeiros", default=351_000.0, minimum=0, step=500),
    ...
    FieldConfig("def_30_cnt_social_circle", "Inadimplências em 30 dias no círculo social", "Histórico cadastral", default=0.0, minimum=0, step=1),
